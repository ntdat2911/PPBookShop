...
export type GetBookByIdQuery = { __typename?: 'Query', getBookById: { __typename?: 'BookEntity', BookID: string, CategoryID: string, CategoryName: string, BookTitle: string, BookPrice: number, BookDescription: string, AuthorBy: string, AuthorName: string, ImageURL: string, Rating: number, Promotion?: Array<{ __typename?: 'PromotionEntity', PromotionID: string, PromotionName: string, DiscountPercent: number }> | null } };
